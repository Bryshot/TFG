...
/// <summary>
/// Añade todas las ventanas en sel
/// </summary>
/// <param name="sel">ComboBox donde estaran todas las ventanas</param>
	...
	startLoop:
		...
		if (match) {
			switchScene(scene, transition,
				    transitionOverrideOverride, lock);
		}
	}
endLoop:
	blog(LOG_INFO, "AutoPro stopped");
}

...
void SwitcherData::loadGeneralSettings(obs_data_t *obj)
{
	...
	obs_data_set_default_int(obj, "fileTabPos", 2);
	obs_data_set_default_int(obj, "randomTabPos", 3);
	obs_data_set_default_int(obj, "sequenceTabPos", 4);
...
/// <summary>
/// Función encargada de la lógica de la Tab General
/// </summary>
